...
router.get('/admin', function(req, res) {
  ...
  res.render('admin_page_index', props);
})
router.get('/admin_manage', function(req, res) {
  ...
  res.render('admin_page_manage', props);
})
router.get('/admin_message', function(req, res) {
  var props = {
    idx: 30,
    id: req.session.user_id
  }

  res.render('admin_page_message', props);
})
router.get('/admin_notice', function(req, res) {
  ...
  if(screen == "read") {
    ...
    res.redirect('/admin_notice?category=all&page=1');
    return;
  } else {
    props.screen = "home"
  }

  res.render('admin_page_notice', props);
})
router.get('/admin_statistics', function(req, res) {
  ...
  res.render('admin_page_statistics', props);
})
  ...
  var json = {
    ...
    state: [
      ...
      },
      {
        ...
        state_old: 10,
        state_now: 12,
        state_date: "2021-12-05 07:21:33"
      },
      {
        device_id: "NIAQ001000",
        device_name: "AirSignal",

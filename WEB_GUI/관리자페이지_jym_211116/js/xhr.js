...
const GET_RANGE_DATA = "postRangeData";
const GET_SENSOR_DATA = "postData";
const REQUEST_DATABASE = "postRequestDB";
const USER_INFO = "userInfo";
const DEVICE_INFO = "deviceInfo";
const GET_NOTICE = "showNotice";
const SEND_NOTICE = "sendNotice";
const DEL_NOTICE = "deleteNotice";
const GET_MESSAGE = "showMessage";
const SEND_MESSAGE = "sendMessage";
const DEL_MESSAGE = "deleteMessage";
...
function classifyResponse(res, addr) {
  ...
  switch (addr) {
    ...
    case GET_NOTICE: case GET_MESSAGE:
      result = res;
      break;
    case GET_EQUIPMENT:
...
function xhrConnect(method = GET, address, value, cb) {
  ...
  xhr.onload = function () {
    ...
    //if(spinner != undefined) spinner.remove();
  }
}
